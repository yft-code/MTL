<template>
    <div class="start-test">
        ...
        <test-conclusion :axiosList="axiosList" :appUrl="appUrl" ref="editConclusionRef"></test-conclusion>
        ...
        <div class="container">
            ...
            <div v-if="canLoadTable">
                <div style="margin-bottom:1rem;">
                    ...
                    <el-button type="danger" size="small" @click="editTestConclusion">提交测试结论</el-button>
...
import SceneTable from '@/components/StartTest/WeaknetPC/SceneTable'
import AddTestScene from '@/components/StartTest/WeaknetPC/AddTestScene'
...
export default {
    ...
    methods: {
        ...
        //表格数据列
        getTableData() {
            this.$codePost("/" + this.appUrl + "/get_test_record/", { application_id: this.axiosList.id,content_name:this.axiosList.table_name, table_name: this.axiosList.table_name }).then(res => {
                if(res.code == 200){
        ...
        async getDeviceData(){
            ...
            let res = await this.$codePost("/" + this.appUrl + "/get_test_device/", list, { operation: "获取测试设备数据", failed: true });
            if(res.code == 200){
