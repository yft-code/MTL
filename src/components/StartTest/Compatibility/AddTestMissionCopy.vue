        ...
        <self-dialog 
            ...
            <el-card>
                <el-form :model="fixDeviceForm" ref="fixDeviceRef" label-width="150px" :rules="fixDeviceFormRules">
                    ...
                    <!-- 指定设备 -->
                    <!-- <div v-if="isFixDevice">
                        <el-form-item label="品牌">
                            <el-button type="info" size="mini">小米</el-button>
                            <el-button type="info" size="mini">华为</el-button>
                            <el-button type="info" size="mini">苹果</el-button>
                            <el-button type="info" size="mini">...</el-button>
                        </el-form-item>
                        <el-form-item label="最低cpu">
                            <el-button type="info" size="mini">MTL 天玑9000</el-button>
                            <el-button type="info" size="mini">高通 晓龙8 Gen1</el-button>
                            <el-button type="info" size="mini">...</el-button>
                        </el-form-item>
                    </div> -->

                    <!-- 设备需求数 -->
                    <!-- <el-form-item :label="deviceItemList[showIndex]+'设备需求数'" v-if="!isFixDevice">
                        <el-input v-if="deviceItemList[showIndex] == 'android'" v-model="androidNum" placeholder="" style="width: 100px;" disabled></el-input>
                        <el-input v-if="deviceItemList[showIndex] == 'ios'" v-model="iosNum" placeholder="" style="width: 100px;" disabled></el-input>
                    </el-form-item> -->
                    ...
                    <!-- <el-form-item label="测试数量" v-if="showIndex !== -1">
                        <el-input v-model="testNumber" placeholder="" style="width: 30%"></el-input>
                    ...
                    <!-- <el-card v-if="isFixDevice">
                        <el-table :data="fakeData" align="center" @selection-change="handleSelectionChange">
                            <el-table-column type="selection"></el-table-column>
                            <el-table-column type="expand">
                                <template slot-scope="scope">
                                    <el-table :data="scope.row.deviceList" align="center">
                                        <el-table-column v-for="item,index in deviceItem" :label="item.titleName" :key="index" align="center">
                                            <template slot-scope="scope">
